...
public class TreeUtil {
     ...
     * value: list<TreeNode>
     *
     * @param pid  父节点id，类型为整数
     * @param list 目标list
     * @param <T>  树节点实现类
     * @return 转换成tree后的list
     */
    public static <T extends TreeNode<T>> List<T> listToTree(Integer pid, List<T> list) {
        return listToTree(pid, list, false);
    }
     ...
     * @param pid   父节点id，类型为字符串
     * @param list  目标list
     * @param leafToEmptyArray  叶子节点是否为空集合
     * @param <T>   树节点实现类
     * @return 转换成tree后的list
     */
     ...
     * @return 转换成tree后的list
     */
    public static <T extends TreeNode<T>> List<T> listToTree(Integer pid, List<T> list, boolean leafToEmptyArray) {
        return listToTree(String.valueOf(pid), list, leafToEmptyArray);
    }
