...
public interface CommentService {
     ...
     * @return
     */
    PageBean<CommentVo> findL1AndL2Top10(CommentQuery commentQueryDto);
     ...
     * @return
     */
    PageBean<CommentVo> findL2Comment(CommentQuery commentQuery);
     ...
     * @return
     */
    List<Comment> findByIds(List<Integer> ids);
...
//    CommentVo processPostComment(UserInfoSessionDto userinfo, Comment comment, boolean needAudit);
     ...
     * @param status
     */
    void batchEditStatus(List<Integer> ids, Integer status);
     ...
     * @return
     */
    List<Comment> findByPid(List<Integer> ids);
}
