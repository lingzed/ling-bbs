...
public class LikeRecordServiceImpl implements LikeRecordService {
    private static final Logger log = LoggerFactory.getLogger(LikeRecordServiceImpl.class);
     ...
     */
    @Override
    public PageBean<LikeRecord> findByCondition(LikeRecordQuery likeRecordQueryDto) {
     ...
     * @return
     */
    public List<LikeRecord> findListByCondition(LikeRecordQuery likeRecordQueryDto) {
        return likeRecordMapper.selectByCondition(likeRecordQueryDto);
    }
     ...
     */
    @Override
    public List<LikeRecordVo> findVoListByCondition(LikeRecordQuery likeRecordQueryDto) {
        return findListByCondition(likeRecordQueryDto).stream().map(e -> {
            LikeRecordVo likeRecordVo = new LikeRecordVo();
            BeanUtils.copyProperties(e, likeRecordVo);
            return likeRecordVo;
     ...
     */
    @Override
    public Long findTotalByCondition(LikeRecordQuery likeRecordQueryDto) {
