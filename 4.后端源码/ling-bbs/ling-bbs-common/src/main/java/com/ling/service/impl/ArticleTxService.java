...
public class ArticleTxService {
    ...
    private void sendMsg(String author, String articleId, String title, String content) {
        ...
        String sign = StrUtil.generateHmacSha256Hex(adminConfig.getSecretKey(), author + currentTime);
        String url = innerUrl + "/send-msg?userId=" + author + "&timestamp=" + currentTime + "&sign=" + sign;
