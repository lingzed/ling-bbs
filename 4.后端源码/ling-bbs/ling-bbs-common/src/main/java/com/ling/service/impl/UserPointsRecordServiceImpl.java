...
import com.ling.entity.vo.PointsRecordVo;
...
public class UserPointsRecordServiceImpl implements UserPointsRecordService {
    private static final Logger log = LoggerFactory.getLogger(UserPointsRecordServiceImpl.class);
    ...
    @Override
    public PageBean<UserPointsRecord> findByCondition(UserPointsRecordQuery userPointsRecordParam) {
        try {
     ...
     */
    @Override
    public Long countByCondition(UserPointsRecordQuery userPointsRecordQueryDto) {
        return userPointsRecordMapper.countByCondition(userPointsRecordQueryDto);
    }
