...
public interface AttachmentDownloadRecordMapper {
     ...
     * @param
     */
    List<AttachmentDownloadRecord> selectByCondition(AttachmentDownloadRecordQuery attachmentDownloadRecordQuery);
     ...
     * @param
     */
    Long selectCountByCondition(AttachmentDownloadRecordQuery attachmentDownloadRecordQuery);
