...
public interface AttachmentDownloadRecordService {
     ...
     * @param
     */
    PageBean<AttachmentDownloadRecord> findByCondition(AttachmentDownloadRecordQuery attachmentDownloadRecordQuery);
     ...
     * @param
     */
    Long findTotalByCondition(AttachmentDownloadRecordQuery attachmentDownloadRecordQuery);
