 ...
 * 用户消息查询参数dto
 */
public class UserMessageQuery extends BaseQueryParam {
    ...
    public UserMessageQuery(String articleTitle, String sendNickName, Integer messageType, Integer status) {
