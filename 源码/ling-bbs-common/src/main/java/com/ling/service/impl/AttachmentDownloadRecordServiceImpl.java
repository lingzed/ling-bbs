...
public class AttachmentDownloadRecordServiceImpl implements AttachmentDownloadRecordService {
     ...
     */
    @Override
    public PageBean<AttachmentDownloadRecord> findByCondition(AttachmentDownloadRecordQueryDto attachmentDownloadRecordQueryDto) {
        List<AttachmentDownloadRecord> list = attachmentDownloadRecordMapper.selectByCondition(attachmentDownloadRecordQueryDto);
        Long total = findTotalByCondition(attachmentDownloadRecordQueryDto);
        return PageBean.of(total, attachmentDownloadRecordQueryDto.getPage(), attachmentDownloadRecordQueryDto.getPageSize(), list);
    }
     ...
     */
    @Override
    public Long findTotalByCondition(AttachmentDownloadRecordQueryDto attachmentDownloadRecordQueryDto) {
        return attachmentDownloadRecordMapper.selectCountByCondition(attachmentDownloadRecordQueryDto);
    }
