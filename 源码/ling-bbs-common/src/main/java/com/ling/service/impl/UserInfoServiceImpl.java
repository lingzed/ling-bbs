...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    @Override
    public UserInfoSessionDto login(String IP, String mail, String password, String checkCode, String sCheckCode) {
        log.info("checkCode: {}, sCheckCode: {}", checkCode, sCheckCode);
        if (StrUtil.isEmpty(checkCode) || !Objects.equals(checkCode, sCheckCode))
            throw new BusinessException(CommonMsg.CHECK_CODE_ERROR);
        ...
        boolean isAdmin = ArrayUtils.contains(webConfig.getAdminAccount().split(","), userInfo.getEmail());
