...
public class RequestLogRecordAspect {
    private Logger log = LoggerFactory.getLogger(RequestLogRecordAspect.class);

    @Resource
    private ObjectMapper objectMapper;

    @Pointcut("@annotation(com.ling.annotation.RequestLogRecord)")
    public void pt() {
    ...
    public void logMethodExecute(JoinPoint joinPoint) {
        try {
            ...
            RequestLogRecord lme = method.getAnnotation(RequestLogRecord.class);
